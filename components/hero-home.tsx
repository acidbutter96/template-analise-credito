          ...
          <div className="pb-12 text-center md:pb-16">
            ...
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={300}
              >
                New Orleans-based painter working in oil and mixed media. I
                create expressive, color-driven canvases inspired by music,
                memory, and the city's light. Commissions, original works, and
                prints available.
              </p>
